  ...
  return (
    <>
      ...
      >
        ...
        <div className="--nf-newsreader absolute left-1/2 top-1/2 mt-6 w-full -translate-x-1/2 -translate-y-1/2 px-5">
          <div className="mx-auto max-w-[900px] text-center">
            <p className="--nf-instrument text-base font-bold md:text-lg">
      ...
      <section className="flex items-center justify-center bg-brandgray px-5 py-[50px] text-center">
      ...
      <section className="flex flex-col text-ink lg:max-h-[600px] lg:flex-row lg:items-stretch">
        ...
        <div className="flex flex-col justify-center px-5 py-10 lg:flex-[0_0_66.66%] lg:px-[50px] lg:py-5">
      ...
      <section className="bg-white px-10 py-10 text-ink">
      ...
      >
        <div className="flex flex-col justify-center px-5 py-10 lg:flex-[0_0_66.66%] lg:px-[50px] lg:py-5">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="font-newsreader text-xl leading-[30px] text-ink lg:leading-[38px]">
              I'm 26 years old and originally graduated in Civil Engineering from
      ...
      <section className="bg-sage px-5 pb-[60px] pt-[70px] text-ink md:px-10">
        <h2 className="mb-[50px] mt-5 text-center font-instrument text-[42px] font-normal text-ink md:mb-20 md:text-[70px]">
      ...
      <section
        className="flex items-center justify-center bg-cover bg-center px-5 py-[50px] text-center"
      ...
      {/* FAQ */}
      <section id="faq" className="faq-section bg-white px-[30px] pb-20 pt-[60px] text-ink">
        <h2 className="mb-[30px] mt-[15px] text-center font-instrument text-[42px] font-normal text-ink md:text-[70px]">
