...
export default function Home() {
  return (
    <>
      ...
      <section className="bg-sage px-5 pb-[60px] pt-[25px] text-ink md:px-10">
        <h2 className="mb-8 mt-5 text-center font-instrument text-[42px] font-normal text-ink md:mb-20 md:text-center md:text-[70px]">
          When I know it's time to change my website?
        </h2>
        <div className="mx-auto grid text-center max-w-[1400px] grid-cols-1 gap-5 sm:grid-cols-[repeat(auto-fit,minmax(320px,1fr))] md:gap-[60px]">
          {[
            {
