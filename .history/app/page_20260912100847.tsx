  ...
  return (
    <>
      ...
      <section className="flex flex-col text-ink lg:max-h-[600px] lg:flex-row lg:items-stretch">
        ...
        <div className="flex flex-col justify-center px-5 py-10 lg:flex-[0_0_66.66%] lg:px-[50px] lg:py-16">
      ...
      >
        <div className="flex flex-col justify-center px-5 py-12 lg:flex-[0_0_66.66%] lg:px-[50px] lg:py-16">
          <h2 className="mb-5 font-instrument text-[42px] font-normal text-ink lg:text-[60px]">
