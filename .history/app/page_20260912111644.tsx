  ...
  return (
    <>
      ...
      <section id="faq" className="faq-section bg-white px-3 pb-20 pt-[40px] text-ink md:px-[30px]">
        <h2 className="mb-[300px] mt-[15px] whitespace-nowrap text-center font-instrument text-[42px] font-normal tracking-tight text-ink md:whitespace-normal md:tracking-normal md:text-[70px]">
