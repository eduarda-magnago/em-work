...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "I build fully custom websites using Next.js, TypeScript, and Tailwind CSS, a modern, high-performance stack that delivers fast load times, clean and maintainable code, and full flexibility to scale as your business grows. Before writing any code, I design every layout in Figma, so we can align on the visual direction and structure of the site before development begins. This combination of a solid design process and a modern tech stack ensures a site that's not only visually polished, but technically robust and built to last.",
  },
];
