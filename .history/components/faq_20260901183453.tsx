...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "I build fully custom websites using Next.js, TypeScript, and Tailwind CSS. Before writing any code, I design every layout in Figma, so we can align on the visual direction and structure of the site before development begins. This combination of a solid design process and a modern tech stack ensures a site that's not only visually polished, but technically robust and built to last.",
  },
];
