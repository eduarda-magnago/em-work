...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "It depends on the type of service you need. The final cost also varies based on where you choose to register your domain and host your website. I'll always provide a personalized quote after understanding your project's goals and technical needs.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "I build fully custom websites using Next.js, Tailwind CSS, and TypeScript. Before writing any code, I design every layout in Figma, so we can align on the visual direction and structure of the site before development begins. This combination of a solid design process and a modern tech stack ensures a site that's not only visually polished, but technically robust and built to last.",
  },
];
...
export default function Faq() {
  ...
  return (
    <div className="mx-auto max-w-[1000px] pl-5 md:pl-10">
      {faqs.map((faq, i) => {
