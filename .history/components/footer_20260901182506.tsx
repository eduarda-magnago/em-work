...
export default function Footer() {
  return (
    <footer className="bg-charcoal px-6 pb-[30px] pt-10 text-white md:px-[60px] md:pt-20">
      <div className="flex flex-col gap-6 md:flex-row md:flex-wrap md:items-center md:gap-10">
        <div className="min-w-[200px] flex-[1.5] font-instrument text-[80px] leading-none md:text-[150px]">
          <Link href="/#home">E.M.</Link>
        </div>

        <div className="flex flex-col gap-10 text-left md:flex-row md:flex-wrap md:justify-end md:gap-[150px]">
