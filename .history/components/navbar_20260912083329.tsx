  ...
  return (
    <nav className="relative px-5 py-5 md:px-[60px] md:py-[30px]">
      <div className="flex md:hidden items-center justify-between">
        <div className="font-instrument text-[32px]"><Link href="/#home">E.M.</Link></div>
        <button onClick={() => setOpen(true)} className="text-3xl cursor-pointer">☰</button>
      </div>
      ...
      <div className="hidden md:flex items-center justify-between gap-10">
        ...
        <div className="min-w-[60px] text-center font-instrument text-[70px]">
          <a href="#home">E.M.</a>
        </div>
